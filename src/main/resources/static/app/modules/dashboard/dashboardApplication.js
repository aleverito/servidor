...
dashboard.config(["$stateProvider", function ($stateProvider) {
    ...
    $stateProvider.state('app.estudiantes', {
    	url: '/estudiantes',
    	templateUrl: 'app/modules/dashboard/estudiante/index.html',
    	controller: 'EstudianteController',
    	controllerAs:'ctrl',
        resolve: {
            users: function ($q, UserService) {
                console.log('%c[INFO]%cCargar todos los estudiantes',log.info,log.fx);
    ...
    $stateProvider.state('app.maestros', {
    	url: '/maestros',
    	templateUrl: 'app/modules/dashboard/maestro/index.html',
    	controller: 'MaestroController',
    	controllerAs:'ctrl',
    	resolve: {
    		users: function ($q, MaestroService) {
    			console.log('%c[INFO]%cCargar todos los maestros',log.info,log.fx);
    			var deferred = $q.defer();
    			MaestroService.loadAllUsers().then(deferred.resolve, deferred.resolve);
    			return deferred.promise;
    		}
    	}
    });
...
//    	url: '/registro',
//    	templateUrl: 'app/modules/dashboard/registro/index.html',
